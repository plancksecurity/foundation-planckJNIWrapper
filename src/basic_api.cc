...
JNIEXPORT jobject JNICALL Java_pEp_jniadapter_Engine_trustwords(
        JNIEnv *env,
        jobject obj,
        jobject ident
    )
...
JNIEXPORT jobject JNICALL Java_pEp_jniadapter_Engine_myself(
        JNIEnv *env,
        jobject obj,
        jobject ident
    )
...
JNIEXPORT jobject JNICALL Java_pEp_jniadapter_Engine_updateIdentity(
        JNIEnv *env,
        jobject obj,
        jobject ident
    )
...
JNIEXPORT jobject JNICALL Java_pEp_jniadapter_Engine_setOwnKey(
        JNIEnv *env,
        jobject obj,
        jobject ident,
        jbyteArray fpr
...
JNIEXPORT void JNICALL Java_pEp_jniadapter_Engine_keyMistrusted(
        JNIEnv *env,
        jobject obj,
        jobject ident
    )
...
JNIEXPORT void JNICALL Java_pEp_jniadapter_Engine_keyResetTrust(
        JNIEnv *env,
        jobject obj,
        jobject ident
    )
...
JNIEXPORT void JNICALL Java_pEp_jniadapter_Engine_trustPersonalKey(
        JNIEnv *env,
        jobject obj,
        jobject ident
    )
...
JNIEXPORT void JNICALL Java_pEp_jniadapter_Engine_trustOwnKey(
        JNIEnv *env,
        jobject obj,
        jobject ident
    )
...
JNIEXPORT void JNICALL Java_pEp_jniadapter_Engine_importKey(
        JNIEnv *env,
        jobject obj,
        jbyteArray key
    )
...
JNIEXPORT void JNICALL Java_pEp_jniadapter_Engine_config_1passive_1mode(
        JNIEnv *env,
        jobject obj,
        jboolean enable
    )
...
JNIEXPORT void JNICALL Java_pEp_jniadapter_Engine_config_1unencrypted_1subject(
        JNIEnv *env,
        jobject obj,
        jboolean enable
    )
...
JNIEXPORT void JNICALL Java_pEp_jniadapter_Engine_blacklist_1add(
        JNIEnv *env,
        jobject obj,
        jbyteArray fpr
    )
...
JNIEXPORT void JNICALL Java_pEp_jniadapter_Engine_blacklist_1delete(
        JNIEnv *env,
        jobject obj,
        jbyteArray fpr
    )
...
JNIEXPORT jboolean JNICALL Java_pEp_jniadapter_Engine_blacklist_1is_1listed(
        JNIEnv *env,
        jobject obj,
        jbyteArray fpr
    )
...
JNIEXPORT jbyteArray JNICALL Java_pEp_jniadapter_Engine_getCrashdumpLog(
        JNIEnv *env,
        jobject obj,
        jint dummy,
        jint maxlines
