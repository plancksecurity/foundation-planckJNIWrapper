...
namespace pEp {
    namespace JNIAdapter {
        ...
        jobject from_stringpairlist(JNIEnv *env, stringpair_list_t *sl)
        {
            ...
            jclass clazz_pair = findClass(env, "pEp/jniadapter/Pair");
            jmethodID constructor = env->GetMethodID(clazz, "<init>", "()V");
            assert(constructor);
        ...
        stringpair_list_t *to_stringpairlist(JNIEnv *env, jobject obj)
        {
            ...
            jfieldID first_id = getFieldID(env, "pEp/jniadapter/Pair",
                    "first", "Ljava/lang/Object;");
            jfieldID second_id = getFieldID(env, "pEp/jniadapter/Pair",
        ...
        jobject from_identity(JNIEnv *env, pEp_identity *ident)
        {
            ...
            static const char *classname = "pEp/jniadapter/_Identity";
            jclass clazz = findClass(env, classname);
            jmethodID constructor = env->GetMethodID(clazz, "<init>", "()V");
            assert(constructor);
            jobject obj = env->NewObject(clazz, constructor);
        ...
        jobject _from_blob(JNIEnv *env, bloblist_t *b)
        {
            ...
            static const char *classname = "pEp/jniadapter/_Blob";
            jclass clazz = findClass(env, classname);
            jmethodID constructor = env->GetMethodID(clazz, "<init>", "()V");
            assert(constructor);
            jobject obj = env->NewObject(clazz, constructor);
        ...
        {
            static const char *classname = "pEp/jniadapter/Message$EncFormat";
        ...
        {
            static const char *classname = "pEp/jniadapter/Message$CipherSuite";
            jclass clazz_enc_format = findClass(env, classname);
            jfieldID field_value = env->GetFieldID(clazz_enc_format, "value", "I");
            assert(field_value);
        ...
        {
            static const char *classname = "pEp/jniadapter/SyncHandshakeResult";
            jclass clazz_enc_format = findClass(env, classname);
            jfieldID field_value = env->GetFieldID(clazz_enc_format, "value", "I");
            assert(field_value);
